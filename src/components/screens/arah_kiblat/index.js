...
class Arah_Kiblat extends Component {
  constructor() {
    super();
    this.state = {
      magnetometer: "0",
    ...
    return (
      <Grid style={{backgroundColor: "black"}}>
        <Row style={{alignItems: "center"}} size={0.9}>
            <Text style = {{color:'white',fontSize:15,textAlign:'center'}}>Sesuaikan Derajat/Sudut Anda {this.props.navigation.state.params.Qibla} Berikut dengan Mengerakan Handphone.</Text>
        </Row>
